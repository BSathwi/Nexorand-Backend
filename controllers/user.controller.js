...
const { format, isValid } = require("date-fns"); // For date formatting and validation
const ClaimHistory = require("../models/claimsHistory.model.js");
...
exports.getUserWithHelpOfToken = async (req, res) => {
  try {
...
exports.getUserWithHelpOfId = async (req, res) => {
  try {
